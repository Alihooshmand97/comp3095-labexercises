...
public class NotificationService {
    ...
    public void listen(OrderPlacedEvent orderPlacedEvent){
        ...
        MimeMessagePreparator messagePreparator = mimeMessage -> {
            ...
            mimeMessageHelper.setFrom("Hooshi.clover@gmail.com");
            mimeMessageHelper.setTo(orderPlacedEvent.getEmail());
            mimeMessageHelper.setSubject(String.format("Your Order (%s) was  successfully", orderPlacedEvent.getOrderNumber()));
